...
if (process.argv.includes('--help') || process.argv.includes('-h')) {
  console.log(`
Usage: npx tsx infrastructure/tools/kubernetes-deployer/examples/deploy-to-minikube.ts [options]
...
Examples:
  # Normal deployment
  npx tsx infrastructure/tools/kubernetes-deployer/examples/deploy-to-minikube.ts
