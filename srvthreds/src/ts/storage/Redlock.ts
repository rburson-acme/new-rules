...
export default class Redlock extends EventEmitter {
  ...
  public async using<T>(
    ...
    const routine = (optionalRoutine ?? settingsOrRoutine) as (signal: RedlockAbortSignal) => Promise<T>;
    ...
    const controller = typeof AbortController === 'undefined' ? new PolyfillAbortController() : new AbortController();
