...
import { executeDockerComposeDeployment, executeDockerComposeDeployments, DeploymentArguments, PostUpCommand, ComposeFiles, EnvironmentOverrides, processExitError } from './deployment.js';

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);
const configsDir = path.join(__dirname, '..', '..', 'shared', 'configs', 'deployments');

export type DeploymentType = 'docker-compose';
