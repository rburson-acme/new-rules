  ...
  const modules: RouteListItemType<ModuleNames>[] = [
    {
      ...
      navigateFn: () => navigation.navigate('Module', { name: 'Health Information' }),
    },
    {
      description: 'Allows for NewRules to determine your geolocation and send data to connected services. ',
      name: 'Geolocation',
      iconName: 'location-on',
      navigateFn: () => navigation.navigate('Module', { name: 'Geolocation' }),
    },
    {
      ...
      navigateFn: () => navigation.navigate('Module', { name: 'Fall/Injury Detection' }),
    },
  ];
